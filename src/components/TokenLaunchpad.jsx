import { createInitializeAccount2Instruction, createMint, getMinimumBalanceForRentExemptMint, MINT_SIZE, TOKEN_PROGRAM_ID } from "@solana/spl-token";
...
export function TokenLaunchpad() {
    ...
    async function createToken() {
        ...
        const transaction = new Transaction().add(
            ...
            createInitializeAccount2Instruction(keypair.publicKey, 6, wallet.publicKey, wallet.publicKey,TOKEN_PROGRAM_ID)
        );
